...
# Function to handle dynamic login flow using Playwright
def login_to_x(page, username, password, mobile_number):
    ...
    # Click "Next" after entering username
    page.click('//button[contains(@class, "css-175oi2r") and .//span[text()="Next"]]')
    time.sleep(4)

    while True:
        try:
            # Check if the password field is present and fill it
        ...
        try:
            ...
            if page.is_visible('input[data-testid="ocfEnterTextTextInput"]'):
                page.fill('input[data-testid="ocfEnterTextTextInput"]', mobile_number)
...
# Function to scrape hashtag-related posts using Playwright
...
# Helper function to extract post data using BeautifulSoup
...
def scrape_twitter(data):
    ...
    # Launch Playwright and setup browser
